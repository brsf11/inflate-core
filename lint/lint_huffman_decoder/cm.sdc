...
#################################################################################
# create_clock
create_clock [get_ports clk] -name CLK0_NAME -period $CLK0_SCALE_PERIOD
...
# IO Delay Setting
################################################################################
set_input_delay  -max [expr $CLK0_SCALE_PERIOD * $INPUT_DELAY_SCALE_RATIO] -clock CLK0_NAME [remove_from_collection [all_inputs] [get_ports {*clk* *rst*}]]

set_input_delay  -min 0 -clock CLK0_NAME [remove_from_collection [all_inputs] [get_ports {*clk* *rst*}]]
